...
##</argon2-stretch>##
	...
	apt-get install -y --no-install-recommends \
		...
		libxml2-dev \
		zlib1g-dev \
# ============== Custom added extended dependency packages  =======================
                libfreetype6-dev \
                libjpeg62-turbo-dev \
                libpng-dev \
                zlib1g-dev \
                libxml2-dev \
                libmcrypt-dev \
# =============== End custom added extended dependency packages ===================
...
# ============== Extensions to customize additions ==================
                --with-mysqli=mysqlnd \
...
# ============== End Extensions to customize additions ================
		\
...
curl -fsSL 'https://codeload.github.com/phpredis/phpredis/tar.gz/5.0.2' -o phpredis-5.0.2.tar.gz \
    && apt-get install -y --no-install-recommends autoconf \
    && tar -zxf phpredis-5.0.2.tar.gz \
    && rm phpredis-5.0.2.tar.gz \
    && ( \
        cd phpredis-5.0.2 \
        && phpize \
